...
export class RunService {
  ...
  runCurrentModel():Observable<ExecuteRunResponse> {
  ...
  getRunHistory(): Observable<RunResponse> {
    return this.appDaoService.getRunHistory(this.currentStateService.currentDocument.modelName);
  }
}
